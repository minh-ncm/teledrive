...
from PySide6.QtWidgets import (
    QApplication, QLabel, QMainWindow, QPushButton, QVBoxLayout, QWidget, QLineEdit
)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        layout.addWidget(QLineEdit(), alignment=Qt.AlignmentFlag.AlignCenter)
...
if __name__ == "__main__":
    ...
    main_window.setWindowTitle("hellow")
